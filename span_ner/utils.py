...
from src.span_ner.misc import extract_json_data
from src.span_ner.misc import iob_tagging, f1_score
...
class UnitAlphabet(object):
    ...
    def __init__(self, source_path):
        self._tokenizer = BertTokenizer.from_pretrained(
            source_path, do_lower_case=True
        )
...
class Procedure(object):
    ...
    def test(model, dataset):
        ...
        out_f1 = f1_score(seqs, outputs, oracles)
        return out_f1, time.time() - time_start, seqs, outputs, oracles
